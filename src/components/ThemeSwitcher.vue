...
export default {
    ...
    methods: {
        saveThemeSettings() {
            localStorage.setItem('themeSwitcher', JSON.stringify({
                theme: this.$appState.theme,
                selectedPrimaryColor: this.selectedPrimaryColor,
                selectedSurfaceColor: this.selectedSurfaceColor,
                ripple: this.$primevue.config.ripple,
