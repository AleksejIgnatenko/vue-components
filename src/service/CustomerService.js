export const Columns = [
    { field: 'name', header: 'Name', filterType: 'text', width: '20%', editorType: 'text' },
    { field: 'country.name', header: 'Country', filterType: 'text', width: '15%', editorType: 'text' },
    { field: 'company', header: 'Company', filterType: 'text', width: '20%', editorType: 'text' },
    { field: 'status', header: 'Status', filterType: 'multiselect', enumValues: ['unqualified', 'qualified', 'new', 'negotiation', 'renewal', 'proposal'], width: '15%', editorType: 'select' },
    { field: 'representative.name', header: 'Representative', filterType: 'multiselect', enumValues: ['Amy Elsner', 'Anna Fali', 'Asiya Javayant', 'Bernardo Dominic', 'Elwin Sharvill', 'Ioni Bowcher', 'Ivan Magalhaes', 'Onyama Limba', 'Stephen Shaw', 'XuXue Feng'], width: '20%', editorType: 'file' },
];
...
export const CustomerService = {
        ...
        getCustomersPage(page = 1, size = 5) {
            return Promise.resolve(this.getData().slice((page - 1) * size, page * size));
        },
